...
public class TestTupleLiteral {
    ...
    public void testAddValues() {
        ...
        tuple.addValue(Integer.valueOf(3));
        tuple.addValue("hello");
        tuple.addValue(Double.valueOf(2.1));
        tuple.addValue(null);
        tuple.addValue(Long.valueOf(-6L));
        ...
        assert tuple.getColumnValue(2).equals(Double.valueOf(2.1));
        assert tuple.getColumnValue(3) == null;
        assert tuple.getColumnValue(4).equals(Long.valueOf(-6L));
    }
